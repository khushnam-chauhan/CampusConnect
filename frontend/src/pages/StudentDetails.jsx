    ...
    try {
      ...
      setFormData((prev) => ({
        ...
        profilePhoto: res.data.profilePhoto
          ? res.data.profilePhoto.startsWith("http") || res.data.profilePhoto.startsWith("/")
        ...
        hasCertifications: res.data.certifications?.length > 0,
  ...
  const handleSubmit = async (e) => {
    ...
    Object.keys(formData).forEach((key) => {
      if (key === "education" || key === "experience") {
        ...
        // Properly stringify the skills array
        formDataToSend.append(key, JSON.stringify(formData[key]));
                    ...
                    <div className="form-group">
                      ...
                      <div className="file-input-container">
                        <button
                          ...
                          onClick={() =>
                            document
                              .getElementById(`certImage-${index}`)
                              .click()
                          }
                        >
